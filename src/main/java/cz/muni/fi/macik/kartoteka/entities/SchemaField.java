...
import cz.muni.fi.macik.kartoteka.validator.NumberValidator;
import cz.muni.fi.macik.kartoteka.validator.RegexValidator;
import cz.muni.fi.macik.kartoteka.validator.TrueFalseValidator;
...
public class SchemaField {
    ...
    public SchemaField(ObjectId id, String fieldTitle, boolean mandatory, String constraint, String regex, boolean repeatable, Validator validator) {
        this.id = id;
